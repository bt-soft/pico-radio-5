...
class UIComponent {
  protected:
     ...
     * @note Alapértelmezett szerint false, de a származtatott osztályok felülírhatják, ha nem kívánják ezt a viselkedést.
    ...
    /**
     * Csak backward compatibility miatt
     */
    TFT_eSPI getTft() {
  ...
  public:
     ...
     */
    virtual bool handleRotary(const RotaryEvent &event) {
        return false; // Alapértelmezés szerint nem kezeli a rotary eseményeket, de leszármazott osztályok felülírhatják
    }
