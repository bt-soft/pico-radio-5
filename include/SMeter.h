...
constexpr uint8_t MeterBarFinalOrangeStartX =
    MeterBarGreenStartX + ((6 - 1) * MeterBarGreenSpacing) + MeterBarGreenWidth + 2; // Utolsó narancs sáv (S9+60dB felett)
...
class SMeter : public UIComponent {
  ...
  public:
     ...
     */
    SMeter(const Rect &bounds, const ColorScheme &colors = ColorScheme::defaultScheme());
